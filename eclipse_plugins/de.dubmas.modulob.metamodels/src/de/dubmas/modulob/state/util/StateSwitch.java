...
public class StateSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StatePackage.TIMEOUT_TRANSITION: {
				TimeoutTransition timeoutTransition = (TimeoutTransition)theEObject;
				T result = caseTimeoutTransition(timeoutTransition);
				if (result == null) result = caseTransition(timeoutTransition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Timeout Transition</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Timeout Transition</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTimeoutTransition(TimeoutTransition object) {
		return null;
	}
