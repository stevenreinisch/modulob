...
public class TypesPackageImpl extends EPackageImpl implements TypesPackage {
	 ...
	 * @see de.dubmas.modulob.types.TypesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getTypeRef_IsMulti() {
	...
	public void initializePackageContents() {
		...
		userDefinedEClass.getESuperTypes().add(this.getType());
		primitiveEClass.getESuperTypes().add(this.getType());
		anyEClass.getESuperTypes().add(this.getType());
