...
public class NotificationImpl extends EObjectImpl implements Notification {
	...
	protected EClass eStaticClass() {
		return ModulobPackage.Literals.NOTIFICATION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, org.eclipse.emf.common.notify.Notification.SET, ModulobPackage.NOTIFICATION__NAME, oldName, name));
	}
	...
	public EList<Feature> getFeatures() {
		if (features == null) {
			features = new EObjectContainmentEList<Feature>(Feature.class, this, ModulobPackage.NOTIFICATION__FEATURES);
		}
		return features;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModulobPackage.NOTIFICATION__NAME:
				return getName();
			case ModulobPackage.NOTIFICATION__FEATURES:
				return getFeatures();
		}
