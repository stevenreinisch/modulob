 ...
 * @generated
 */
public class ModulobPackageImpl extends EPackageImpl implements ModulobPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	private EEnum configOptionEEnum = null;
	 ...
	 * @generated
	 */
	private EEnum configValueEEnum = null;
	 ...
	 * @see de.dubmas.modulob.ModulobPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ModulobPackageImpl() {
		super(eNS_URI, ModulobFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ModulobPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ModulobPackage init() {
		if (isInited) return (ModulobPackage)EPackage.Registry.INSTANCE.getEPackage(ModulobPackage.eNS_URI);

		// Obtain or create and register package
		ModulobPackageImpl theModulobPackage = (ModulobPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ModulobPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ModulobPackageImpl());
		...
		theModulobPackage.createPackageContents();

		// Initialize created meta-data
		theModulobPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theModulobPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ModulobPackage.eNS_URI, theModulobPackage);
		return theModulobPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getDelegate_Methods() {
	 ...
	 * @generated
	 */
	public EReference getInterface_RequiredInterfaces() {
	 ...
	 * @generated
	 */
	public EAttribute getParameter_SignaturePart() {
	 ...
	 * @generated
	 */
	public EAttribute getAnnotation_Option() {
	 ...
	 * @generated
	 */
	public EAttribute getFeature_IsIndexed() {
	 ...
	 * @generated
	 */
	public EAttribute getFeature_IsContainment() {
	 ...
	 * @generated
	 */
	public EReference getFeature_Inverse() {
	 ...
	 * @generated
	 */
	public EEnum getConfigValue() {
		return configValueEEnum;
	}
	 ...
	 * @generated
	 */
	public ModulobFactory getModulobFactory() {
		return (ModulobFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(delegateEClass, DELEGATE__METHODS);
		...
		createEAttribute(featureEClass, FEATURE__IS_INDEXED);
		createEAttribute(featureEClass, FEATURE__IS_CONTAINMENT);
	...
	public void initializePackageContents() {
		...
		delegateEClass.getESuperTypes().add(theTypesPackage.getUserDefined());
		interfaceEClass.getESuperTypes().add(theTypesPackage.getUserDefined());
		entityEClass.getESuperTypes().add(theTypesPackage.getUserDefined());
		...
		initEReference(getDelegate_Methods(), this.getMethod(), null, "methods", null, 0, -1, Delegate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getParameter_Type(), theTypesPackage.getTypeRef(), null, "type", null, 1, 1, Parameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAnnotation_Value(), this.getConfigValue(), "value", null, 0, 1, Annotation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(featureEClass, Feature.class, "Feature", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getFeature_IsIndexed(), ecorePackage.getEBoolean(), "isIndexed", null, 0, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFeature_IsContainment(), ecorePackage.getEBoolean(), "isContainment", null, 0, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getIntegerValue_Value(), ecorePackage.getEIntegerObject(), "value", null, 0, 1, IntegerValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(configOptionEEnum, ConfigOption.PERSISTENCY);

		initEEnum(configValueEEnum, ConfigValue.class, "ConfigValue");
		addEEnumLiteral(configValueEEnum, ConfigValue.CORE_DATA);
