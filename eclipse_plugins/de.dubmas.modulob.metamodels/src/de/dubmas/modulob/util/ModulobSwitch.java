 ...
 * @generated
 */
public class ModulobSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModulobPackage.DELEGATE: {
				Delegate delegate = (Delegate)theEObject;
				T result = caseDelegate(delegate);
				if (result == null) result = caseUserDefined(delegate);
				if (result == null) result = caseType(delegate);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModulobPackage.INTERFACE: {
				Interface interface_ = (Interface)theEObject;
				T result = caseInterface(interface_);
				if (result == null) result = caseUserDefined(interface_);
				if (result == null) result = caseType(interface_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModulobPackage.METHOD: {
			...
			case ModulobPackage.ENTITY: {
				...
				if (result == null) result = caseUserDefined(entity);
			...
			case ModulobPackage.VALUE_OBJECT: {
			...
			case ModulobPackage.STRING_VALUE: {
				...
				if (result == null) result = caseValueObject(stringValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModulobPackage.INTEGER_VALUE: {
				...
				if (result == null) result = caseValueObject(integerValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModulobPackage.FLOAT_VALUE: {
				...
				if (result == null) result = caseValueObject(floatValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
