...
public class SystemPackageImpl extends EPackageImpl implements SystemPackage {
	 ...
	 * @generated
	 */
	public EAttribute getVersionedElement_Current() {
	...
	public void createPackageContents() {
		...
		createEReference(entityModelEClass, ENTITY_MODEL__ENUMS);
		...
		createEAttribute(versionedElementEClass, VERSIONED_ELEMENT__CURRENT);
	...
	public void initializePackageContents() {
		...
		initEReference(getEntityModel_Enums(), theModulobPackage.getEnum(), null, "enums", null, 0, -1, EntityModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getVersionedElement_Current(), ecorePackage.getEBoolean(), "current", null, 0, 1, VersionedElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
