 ...
 * <ul>
 *   <li>{@link de.dubmas.modulob.migration.model.migration.impl.RelationChangeImpl#getSourceExpression <em>Source Expression</em>}</li>
 *   <li>{@link de.dubmas.modulob.migration.model.migration.impl.RelationChangeImpl#getSourceFeature <em>Source Feature</em>}</li>
 *   <li>{@link de.dubmas.modulob.migration.model.migration.impl.RelationChangeImpl#getDestinationFeature <em>Destination Feature</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class RelationChangeImpl extends ChangeImpl implements RelationChange {
	...
	public Feature getSourceFeature() {
		if (sourceFeature != null && sourceFeature.eIsProxy()) {
			...
			if (sourceFeature != oldSourceFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MigrationPackage.RELATION_CHANGE__SOURCE_FEATURE, oldSourceFeature, sourceFeature));
			}
		}
	...
	public void setSourceFeature(Feature newSourceFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MigrationPackage.RELATION_CHANGE__SOURCE_FEATURE, oldSourceFeature, sourceFeature));
	}
	...
	public Feature getDestinationFeature() {
		if (destinationFeature != null && destinationFeature.eIsProxy()) {
			...
			if (destinationFeature != oldDestinationFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MigrationPackage.RELATION_CHANGE__DESTINATION_FEATURE, oldDestinationFeature, destinationFeature));
			}
		}
	...
	public void setDestinationFeature(Feature newDestinationFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MigrationPackage.RELATION_CHANGE__DESTINATION_FEATURE, oldDestinationFeature, destinationFeature));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case MigrationPackage.RELATION_CHANGE__SOURCE_FEATURE:
				if (resolve) return getSourceFeature();
				return basicGetSourceFeature();
			case MigrationPackage.RELATION_CHANGE__DESTINATION_FEATURE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == FeatureChange.class) {
			switch (derivedFeatureID) {
				...
				case MigrationPackage.RELATION_CHANGE__SOURCE_FEATURE: return MigrationPackage.FEATURE_CHANGE__SOURCE_FEATURE;
				case MigrationPackage.RELATION_CHANGE__DESTINATION_FEATURE: return MigrationPackage.FEATURE_CHANGE__DESTINATION_FEATURE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == FeatureChange.class) {
			switch (baseFeatureID) {
				...
				case MigrationPackage.FEATURE_CHANGE__SOURCE_FEATURE: return MigrationPackage.RELATION_CHANGE__SOURCE_FEATURE;
				case MigrationPackage.FEATURE_CHANGE__DESTINATION_FEATURE: return MigrationPackage.RELATION_CHANGE__DESTINATION_FEATURE;
				default: return -1;
			}
		}
