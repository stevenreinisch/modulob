 ...
 * <ul>
 *   <li>{@link de.dubmas.modulob.migration.model.migration.EntityChange#getAttributeChanges <em>Attribute Changes</em>}</li>
 *   <li>{@link de.dubmas.modulob.migration.model.migration.EntityChange#getRelationChanges <em>Relation Changes</em>}</li>
 *   <li>{@link de.dubmas.modulob.migration.model.migration.EntityChange#getSourceEntity <em>Source Entity</em>}</li>
 *   <li>{@link de.dubmas.modulob.migration.model.migration.EntityChange#getDestinationEntity <em>Destination Entity</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.dubmas.modulob.migration.model.migration.MigrationPackage#getEntityChange()
 * @model abstract="true"
 * @generated
 */
public interface EntityChange extends Change {
	 ...
	 * The list contents are of type {@link de.dubmas.modulob.migration.model.migration.AttributeChange}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.dubmas.modulob.migration.model.migration.MigrationPackage#getEntityChange_AttributeChanges()
	 ...
	 * The list contents are of type {@link de.dubmas.modulob.migration.model.migration.RelationChange}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.dubmas.modulob.migration.model.migration.MigrationPackage#getEntityChange_RelationChanges()
	 * @model containment="true"
	 * @generated
	 */
	 ...
	 * @see de.dubmas.modulob.migration.model.migration.MigrationPackage#getEntityChange_SourceEntity()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dubmas.modulob.migration.model.migration.EntityChange#getSourceEntity <em>Source Entity</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.dubmas.modulob.migration.model.migration.MigrationPackage#getEntityChange_DestinationEntity()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dubmas.modulob.migration.model.migration.EntityChange#getDestinationEntity <em>Destination Entity</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
